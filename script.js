  ...
  <nav id="navbar" class="fixed top-0 left-0 w-full z-50 bg-white border-b-[3px] border-black transition-all duration-300">
    <div class="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
      ...
      <div class="flex items-center gap-2">
        <a href="https://sideranacio.org" target="_blank" rel="noopener noreferrer" class="btn-primary text-sm py-2 px-4 hidden md:inline-flex">
          Join Us
    ...
    <div id="mobile-menu" class="hidden md:hidden border-t-[3px] border-black bg-white">
      <div class="px-6 py-4 flex flex-col gap-2">
        ${mobileLinks}
        <a href="https://sideranacio.org" target="_blank" rel="noopener noreferrer" class="btn-primary text-sm w-full justify-center">
          Join Us
          <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/></svg>
        </a>
      </div>
